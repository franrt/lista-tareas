...
for (var i = 0; i < 10; i++) { //Esta función recorre el arreglo y devuelve las primeras 10 tareas en forma de lista desordenada (con bullets)
    document.write("<div><UL><li>Task: " + res[i].title + "<br></li><UL></div>");
}

function printTask() { //con esta función se agrega y se imprime la nueva tarea en el html
